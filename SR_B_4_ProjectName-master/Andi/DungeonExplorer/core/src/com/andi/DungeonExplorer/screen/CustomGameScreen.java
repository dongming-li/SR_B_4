...
public class CustomGameScreen extends AbstractScreen implements CutscenePlayer, CutsceneEventQueuer {
     ...
     * @param account
     */
    public CustomGameScreen(DungeonExplorer app, Account account, String worldName) {
        super(app);
        ...
        AnimationSet mortyAnimations = new AnimationSet(
                new Animation(0.3f/2f, atlas.findRegions("Morty_Walk_North"), Animation.PlayMode.LOOP_PINGPONG),
                new Animation(0.3f/2f, atlas.findRegions("Morty_Walk_South"), Animation.PlayMode.LOOP_PINGPONG),
                new Animation(0.3f/2f, atlas.findRegions("Morty_Walk_East"), Animation.PlayMode.LOOP_PINGPONG),
                new Animation(0.3f/2f, atlas.findRegions("Morty_Walk_West"), Animation.PlayMode.LOOP_PINGPONG),
        ...
        //player = new PlayerActor(world, 8, 8, mortyAnimations);
        player = new PlayerActor(world, editorUtil.getSpawnX(), editorUtil.getSpawnY(), mortyAnimations);
        ...
        player.character.maxHealth += 2500;
        player.character.heal(2500);
